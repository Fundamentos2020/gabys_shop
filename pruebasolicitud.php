    ...
    if(isset($_POST['subir'])){
        ...
        if($nombre != ""){
            if(copy($ruta,$destino)){
                ...
                $dns = 'mysql:host=localhost;dbname=proyecto;charset=utf8';
                $username = 'root';
                $password = '';
                ...
                $id1 = 0;
                $id2 = 0;
                $query = $connection->prepare('INSERT INTO solicitud(id_vendedor, solicitudRuta, id_admin, aprobada) 
                VALUES(:idv, :nombre, :id1, :id1)');
